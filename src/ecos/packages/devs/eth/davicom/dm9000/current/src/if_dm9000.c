...
//#define DEBUG
//#define DEBUG_DUMP
//#define _DEBUG_ // Added by gyr 2013.05.11
...
#define DM9000_CS_PIN     CYGHWR_HAL_STM32_GPIO(G, 12, OUT_50MHZ, ALT_PUSHPULL)

#define DM9000_OE_PIN     CYGHWR_HAL_STM32_GPIO(D,  4, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_WE_PIN     CYGHWR_HAL_STM32_GPIO(D,  5, OUT_50MHZ, ALT_PUSHPULL)

#define DM9000_A2_PIN     CYGHWR_HAL_STM32_GPIO(F,  2, OUT_50MHZ, ALT_PUSHPULL)

#define DM9000_A19_REV1_0 CYGHWR_HAL_STM32_GPIO(E,  3, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_A20_REV1_0 CYGHWR_HAL_STM32_GPIO(E,  4, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_A19_REV2_0 CYGHWR_HAL_STM32_GPIO(E,  5, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_A20_REV2_0 CYGHWR_HAL_STM32_GPIO(E,  6, OUT_50MHZ, ALT_PUSHPULL)

#define DM9000_D0_PIN     CYGHWR_HAL_STM32_GPIO(D, 14, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D1_PIN     CYGHWR_HAL_STM32_GPIO(D, 15, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D2_PIN     CYGHWR_HAL_STM32_GPIO(D,  0, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D3_PIN     CYGHWR_HAL_STM32_GPIO(D,  1, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D4_PIN     CYGHWR_HAL_STM32_GPIO(E,  7, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D5_PIN     CYGHWR_HAL_STM32_GPIO(E,  8, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D6_PIN     CYGHWR_HAL_STM32_GPIO(E,  9, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D7_PIN     CYGHWR_HAL_STM32_GPIO(E, 10, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D8_PIN     CYGHWR_HAL_STM32_GPIO(E, 11, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D9_PIN     CYGHWR_HAL_STM32_GPIO(E, 12, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D10_PIN    CYGHWR_HAL_STM32_GPIO(E, 13, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D11_PIN    CYGHWR_HAL_STM32_GPIO(E, 14, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D12_PIN    CYGHWR_HAL_STM32_GPIO(E, 15, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D13_PIN    CYGHWR_HAL_STM32_GPIO(D,  8, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D14_PIN    CYGHWR_HAL_STM32_GPIO(D,  9, OUT_50MHZ, ALT_PUSHPULL)
#define DM9000_D15_PIN    CYGHWR_HAL_STM32_GPIO(D, 10, OUT_50MHZ, ALT_PUSHPULL)


static
void dm9000_hw_gpio_init(void)
{
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_CS_PIN );

    CYGHWR_HAL_STM32_GPIO_SET( DM9000_OE_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_WE_PIN );

    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D0_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D1_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D2_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D3_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D4_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D5_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D6_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D7_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D8_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D9_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D10_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D11_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D12_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D13_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D14_PIN );
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_D15_PIN );

    CYGHWR_HAL_STM32_GPIO_SET( DM9000_A2_PIN );

    CYGHWR_HAL_STM32_GPIO_SET( DM9000_A19_REV1_0);
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_A19_REV2_0);
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_A20_REV1_0);
    CYGHWR_HAL_STM32_GPIO_SET( DM9000_A20_REV2_0);
}
...
dm9000_init(struct cyg_netdevtab_entry * ndp)
{
    ...
    dm9000_hw_gpio_init();// Added by reille 2013.05.13
...
#ifdef _DEBUG_
    diag_printf("dm9000_can_send...return %d...active = %d, txbusy = %d, reset_pending = %d \n",
                  (!(!priv->active || priv->txbusy || priv->reset_pending)),
                  priv->active, priv->txbusy, priv->reset_pending);
#endif
...
dm9000_poll(struct eth_drv_sc *sc)
{
...
#ifdef DEBUG
	    diag_printf("pkt_stat = 0x%04x, pkt_len = 0x%04x\n", pkt_stat, pkt_len);
#endif
...
#ifdef _DEBUG_
        diag_printf("DM9000 Recv Packages OK...\n");
#endif
	    }
    ...
    putreg(priv, DM_NSR, txstat);// Added by reille 2013.05.18
...
#ifdef _DEBUG_
  diag_printf("dm9000_int_vector, priv->interrupt = %d...\n", priv->interrupt);
#endif
