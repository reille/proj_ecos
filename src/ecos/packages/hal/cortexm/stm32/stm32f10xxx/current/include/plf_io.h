...
// Author(s):   reille
// Date:        2013-02-22
// Purpose:     STM32F10XXX platform specific registers
// Description:
...
// Added start by reille 2013.06.09
#define CYGHWR_HAL_STM32_I2S2_SD_IN     CYGHWR_HAL_STM32_PIN_ALTFN_IN(  B, 15, NA, NA,       PULLUP )
#define CYGHWR_HAL_STM32_I2S2_SD_OUT    CYGHWR_HAL_STM32_PIN_ALTFN_OUT( B, 15, NA, PUSHPULL, NONE, AT_LEAST(50) )

#define CYGHWR_HAL_STM32_I2S2_WS_IN     CYGHWR_HAL_STM32_PIN_ALTFN_IN(  B, 12, NA, NA,       PULLUP )
#define CYGHWR_HAL_STM32_I2S2_WS_OUT    CYGHWR_HAL_STM32_PIN_ALTFN_OUT( B, 12, NA, PUSHPULL, NONE, AT_LEAST(50) )

#define CYGHWR_HAL_STM32_I2S2_CK_IN     CYGHWR_HAL_STM32_PIN_ALTFN_IN(  B, 13, NA, NA,       PULLUP )
#define CYGHWR_HAL_STM32_I2S2_CK_OUT    CYGHWR_HAL_STM32_PIN_ALTFN_OUT( B, 13, NA, PUSHPULL, NONE, AT_LEAST(50) )

#define CYGHWR_HAL_STM32_I2S2_MCK_OUT   CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 6,  NA, PUSHPULL, NONE, AT_LEAST(50) )
// Added end by reille 2013.06.09
...
// Added start by reille 2013.06.26
// For SDIO
#define CYGHWR_HAL_STM32_SDIO_PIN_DAT0      CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 8,  NA, PUSHPULL, NONE, AT_LEAST(50) )
#define CYGHWR_HAL_STM32_SDIO_PIN_DAT1      CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 9,  NA, PUSHPULL, NONE, AT_LEAST(50) )
#define CYGHWR_HAL_STM32_SDIO_PIN_DAT2      CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 10, NA, PUSHPULL, NONE, AT_LEAST(50) )
#define CYGHWR_HAL_STM32_SDIO_PIN_DAT3      CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 11, NA, PUSHPULL, NONE, AT_LEAST(50) )
#define CYGHWR_HAL_STM32_SDIO_PIN_CLK       CYGHWR_HAL_STM32_PIN_ALTFN_OUT( C, 12, NA, PUSHPULL, NONE, AT_LEAST(50) )
#define CYGHWR_HAL_STM32_SDIO_PIN_CMD       CYGHWR_HAL_STM32_PIN_ALTFN_OUT( D, 2,  NA, PUSHPULL, NONE, AT_LEAST(50) )

#define CYGHWR_HAL_STM32_SDIO_DMA_TX        CYGHWR_HAL_STM32_DMA( 2, 4, 0, M2P )
#define CYGHWR_HAL_STM32_SDIO_DMA_RX        CYGHWR_HAL_STM32_DMA( 2, 4, 0, P2M )

// Added end by reille 2013.06.26
