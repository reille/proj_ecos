...
// Added start by reille 2013.05.24
// OAR1 fields
...
// Added end by reille 2013.05.24
...
#define CYGHWR_HAL_STM32_I2C_SR2_PEC            MASK_(8,7)//MASK_(7,8) // Modified by reille 2013.05.24
...
#define CYGHWR_HAL_STM32_I2C_TRISE_MASK         MASK_(0,5)//MASK_(0,6) // Modified by reille 2013.05.24
...
//=============================================================================
// SDIO Added by reille 2013.06.27

#define CYGHWR_HAL_STM32_SDIO_POWER                 0x00
#define CYGHWR_HAL_STM32_SDIO_CLKCR                 0x04
#define CYGHWR_HAL_STM32_SDIO_ARG                   0x08
#define CYGHWR_HAL_STM32_SDIO_CMD                   0x0C
#define CYGHWR_HAL_STM32_SDIO_RESPCMD               0x10
#define CYGHWR_HAL_STM32_SDIO_RESP(__x)             0x14 + ((__x) << 2)
#define CYGHWR_HAL_STM32_SDIO_DTIMER                0x24
#define CYGHWR_HAL_STM32_SDIO_DLEN                  0x28
#define CYGHWR_HAL_STM32_SDIO_DCTRL                 0x2C
#define CYGHWR_HAL_STM32_SDIO_DCOUNT                0x30
#define CYGHWR_HAL_STM32_SDIO_STA                   0x34
#define CYGHWR_HAL_STM32_SDIO_ICR                   0x38
#define CYGHWR_HAL_STM32_SDIO_MASK                  0x3C
#define CYGHWR_HAL_STM32_SDIO_FIFOCNT               0x48
#define CYGHWR_HAL_STM32_SDIO_FIFO                  0x80

// POWER fields

#define CYGHWR_HAL_STM32_SDIO_POWER_PWROFF          VALUE_(0,0)
#define CYGHWR_HAL_STM32_SDIO_POWER_PWRON           VALUE_(0,3)

// CLKCR fields

#define CYGHWR_HAL_STM32_SDIO_CLKCR_CLKDIV(__x)     VALUE_(1,(__x))
#define CYGHWR_HAL_STM32_SDIO_CLKCR_CLKEN           BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_PWRSAV          BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_BYPASS          BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_WIDBUS_1BIT     VALUE_(11,0)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_WIDBUS_4BIT     VALUE_(11,1)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_WIDBUS_8BIT     VALUE_(11,2)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_NEGEDGE         BIT_(13)
#define CYGHWR_HAL_STM32_SDIO_CLKCR_HWFC_EN         BIT_(14)

// ARG fields

#define CYGHWR_HAL_STM32_SDIO_ARG_CMDARG(__x)       VALUE_(0,(__x))

// CMD fields

#define CYGHWR_HAL_STM32_SDIO_CMD_CMDINDEX(__x)     VALUE_(0,(__x))
#define CYGHWR_HAL_STM32_SDIO_CMD_NORESP_CMDSENT_0  VALUE_(6,0)
#define CYGHWR_HAL_STM32_SDIO_CMD_SHORTRESP_CMDREND VALUE_(6,1)
#define CYGHWR_HAL_STM32_SDIO_CMD_NORESP_CMDSENT_2  VALUE_(6,2)
#define CYGHWR_HAL_STM32_SDIO_CMD_LONGRESP_CMDREND  VALUE_(6,3)
#define CYGHWR_HAL_STM32_SDIO_CMD_WAITNONE          VALUE_(8,0)/*!< SDIO No Wait, TimeOut is enabled */
#define CYGHWR_HAL_STM32_SDIO_CMD_WAITINT           BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_CMD_WAITPEND          BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_CMD_CPSMEN            BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_CMD_SDIOSuspend       BIT_(11)
#define CYGHWR_HAL_STM32_SDIO_CMD_ENCMDcompl        BIT_(12)
#define CYGHWR_HAL_STM32_SDIO_CMD_nIEN              BIT_(13)
#define CYGHWR_HAL_STM32_SDIO_CMD_ATACMD            BIT_(14)


// RESPCMD fields

#define CYGHWR_HAL_STM32_SDIO_RESPCMD_CMDINDEX(__x) VALUE_(0,(__x))

// DLEN fields

#define CYGHWR_HAL_STM32_SDIO_DLEN_DATALENGTH(__x)  VALUE_(0,(__x))

// DCTRL fields

#define CYGHWR_HAL_STM32_SDIO_DCTRL_DTEN            BIT_(0)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DTDIR           BIT_(1)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DMODE           BIT_(2)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DMODE_BLOCK     0
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DMODE_STREAM    BIT_(2)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DMAEN           BIT_(3)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE(__x) VALUE_(4,__x)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_1    VALUE_(4,0)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_2    VALUE_(4,1)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_4    VALUE_(4,2)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_8    VALUE_(4,3)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_16   VALUE_(4,4)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_32   VALUE_(4,5)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_64   VALUE_(4,6)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_128  VALUE_(4,7)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_256  VALUE_(4,8)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_512  VALUE_(4,9)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_1024 VALUE_(4,10)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_2048 VALUE_(4,11)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_4096 VALUE_(4,12)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_8192 VALUE_(4,13)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_DBLOCKSIZE_16384 VALUE_(4,14)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_RWSTART         BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_RWSTOP          BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_RWMOD           BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_DCTRL_SDIOEN          BIT_(11)

// DCOUNT fields

#define CYGHWR_HAL_STM32_SDIO_DCOUNT_DATACOUNT(__x) VALUE_(0,(__x))

// STA fields

#define CYGHWR_HAL_STM32_SDIO_STA_CCRCFAIL          BIT_(0)
#define CYGHWR_HAL_STM32_SDIO_STA_DCRCFAIL          BIT_(1)
#define CYGHWR_HAL_STM32_SDIO_STA_CTIMEOUT          BIT_(2)
#define CYGHWR_HAL_STM32_SDIO_STA_DTIMEOUT          BIT_(3)
#define CYGHWR_HAL_STM32_SDIO_STA_TXUNDERR          BIT_(4)
#define CYGHWR_HAL_STM32_SDIO_STA_RXOVERR           BIT_(5)
#define CYGHWR_HAL_STM32_SDIO_STA_CMDREND           BIT_(6)
#define CYGHWR_HAL_STM32_SDIO_STA_CMDSENT           BIT_(7)
#define CYGHWR_HAL_STM32_SDIO_STA_DATAEND           BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_STA_STBITERR          BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_STA_DBCKEND           BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_STA_CMDACT            BIT_(11)
#define CYGHWR_HAL_STM32_SDIO_STA_TXACT             BIT_(12)
#define CYGHWR_HAL_STM32_SDIO_STA_RXACT             BIT_(13)
#define CYGHWR_HAL_STM32_SDIO_STA_TXFIFOHE          BIT_(14)
#define CYGHWR_HAL_STM32_SDIO_STA_RXFIFOHF          BIT_(15)
#define CYGHWR_HAL_STM32_SDIO_STA_TXFIFOF           BIT_(16)
#define CYGHWR_HAL_STM32_SDIO_STA_RXFIFOF           BIT_(17)
#define CYGHWR_HAL_STM32_SDIO_STA_TXFIFOE           BIT_(18)
#define CYGHWR_HAL_STM32_SDIO_STA_RXFIFOE           BIT_(19)
#define CYGHWR_HAL_STM32_SDIO_STA_TXDVAL            BIT_(20)
#define CYGHWR_HAL_STM32_SDIO_STA_RXDVAL            BIT_(21)
#define CYGHWR_HAL_STM32_SDIO_STA_SDIOIT            BIT_(22)
#define CYGHWR_HAL_STM32_SDIO_STA_CEATAEND          BIT_(23)

// ICR fields

#define CYGHWR_HAL_STM32_SDIO_ICR_CCRCFAILC         BIT_(0)
#define CYGHWR_HAL_STM32_SDIO_ICR_DCRCFAILC         BIT_(1)
#define CYGHWR_HAL_STM32_SDIO_ICR_CTIMEOUT          BIT_(2)
#define CYGHWR_HAL_STM32_SDIO_ICR_DTIMEOUTC         BIT_(3)
#define CYGHWR_HAL_STM32_SDIO_ICR_TXUNDERRC         BIT_(4)
#define CYGHWR_HAL_STM32_SDIO_ICR_RXOVERRC          BIT_(5)
#define CYGHWR_HAL_STM32_SDIO_ICR_CMDRENDC          BIT_(6)
#define CYGHWR_HAL_STM32_SDIO_ICR_CMDSENTC          BIT_(7)
#define CYGHWR_HAL_STM32_SDIO_ICR_DATAENDC          BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_ICR_STBITERRC         BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_ICR_DBCKENDC          BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_ICR_SDIOITC           BIT_(22)
#define CYGHWR_HAL_STM32_SDIO_ICR_CEATAENDC         BIT_(23)

// MASK fields

#define CYGHWR_HAL_STM32_SDIO_MASK_CCRCFAILIE       BIT_(0)
#define CYGHWR_HAL_STM32_SDIO_MASK_DCRCFAILIE       BIT_(1)
#define CYGHWR_HAL_STM32_SDIO_MASK_CTIMEOUTIE       BIT_(2)
#define CYGHWR_HAL_STM32_SDIO_MASK_DTIMEOUTIE       BIT_(3)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXUNDERRIE       BIT_(4)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXOVERRIE        BIT_(5)
#define CYGHWR_HAL_STM32_SDIO_MASK_CMDRENDIE        BIT_(6)
#define CYGHWR_HAL_STM32_SDIO_MASK_CMDSENTIE        BIT_(7)
#define CYGHWR_HAL_STM32_SDIO_MASK_DATAENDIE        BIT_(8)
#define CYGHWR_HAL_STM32_SDIO_MASK_STBITERRIE       BIT_(9)
#define CYGHWR_HAL_STM32_SDIO_MASK_DBCKENDIE        BIT_(10)
#define CYGHWR_HAL_STM32_SDIO_MASK_CMDACTIE         BIT_(11)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXACTIE          BIT_(12)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXACTIE          BIT_(13)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXFIFOHE         BIT_(14)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXFIFOHFIE       BIT_(15)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXFIFOFIE        BIT_(16)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXFIFOFIE        BIT_(17)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXFIFOEIE        BIT_(18)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXFIFOEIE        BIT_(19)
#define CYGHWR_HAL_STM32_SDIO_MASK_TXDVALIE         BIT_(20)
#define CYGHWR_HAL_STM32_SDIO_MASK_RXDVALIE         BIT_(21)
#define CYGHWR_HAL_STM32_SDIO_MASK_SDIOITIE         BIT_(22)
#define CYGHWR_HAL_STM32_SDIO_MASK_CEATAENDIE       BIT_(23)

// FIFOCNT fields

#define CYGHWR_HAL_STM32_SDIO_FIFOCNT_FIFOCOUNT(__x) VALUE_(0,(__x))

// Clock enable bits

#define CYGHWR_HAL_STM32_SDIO_CLOCK             CYGHWR_HAL_STM32_CLOCK( AHB, SDIO )

//#define CYGHWR_HAL_STM32_SDIO_CLOCK             CYGHWR_HAL_STM32_CLOCK( APB2, SDIO )
